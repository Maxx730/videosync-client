...
import { IconButton, Icon, ButtonGroup, List, Whisper, Tooltip } from 'rsuite';
...
export default function Sidebar(props) {
    ...
    return (
        <Panel>
            ...
            {
                tab === 'playlist' && RenderPlaylist(props.playlist, props.removeVideo, props.moveVideo)
            }
            {
...
function RenderPlaylist(videos, removeVideo, moveVideo) {
    return (
        <Content style={{
            padding: 12
        }}>
                                        ...
                                        <div className='move-video-buttons'>
                                            <ButtonGroup vertical>
                                                ...
                                                <Whisper delay={TOOLTIP_TIME} placement="bottom" trigger="hover" speaker={
                                                    ...
                                                    }} appearance='subtle' icon={<Icon icon='caret-down'/>}/>
                                                </Whisper>
                                            </ButtonGroup>
                                        </div>
                                        <div>
